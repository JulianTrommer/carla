...
#include "ScoomaticInputPriority.generated.h"

UENUM(BlueprintType)
enum class EScoomaticInputPriority : uint8
{
...
inline static bool operator<=(EScoomaticInputPriority Lhs, EScoomaticInputPriority Rhs)
{
