...
# Allows controlling a scoomatic with a keyboard. For a simpler and more
...
class World(object):
	...
	for i in range(0, len(self.world.get_blueprint_library())):
		print(self.world.get_blueprint_library()[i])
